...
namespace Zad1
{
    public interface ITodoRepository
    {
        ...
        /// <summary >
        /// Tries to mark a TodoItem as active in database. Throw
        /// TodoAccessDeniedException with appropriate message if user is not
        /// the owner of the Todo item.
        /// </ summary >
        /// <param name =" todoId " > Todo Id </ param >
        /// <param name =" userId " >Id of the user that is trying to mark as active</ param >
        /// <returns > True if success , false otherwise </ returns >
        bool MarkAsActive(Guid todoId, Guid userId);
        ...
        void AddLabel(string value, Guid todoId);
    }
}
